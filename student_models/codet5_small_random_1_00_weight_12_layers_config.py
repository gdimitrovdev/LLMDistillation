...
def codet5_small_random_1_00_weight_3_layers_config(base_path):
    return {
        ...
        "output_dir": os.path.join(base_path, "output_models/student_model_output_codet5_small_random_1_00_weight_12_layers"),
        "teacher_model_name": "Salesforce/codet5-base",
        "model_name": None,
        "model_name_custom": "Salesforce/codet5-small", # Used for custom models
        "model_config_custom": 12, # Used for custom models, number of layers
        "max_src_length": 1024,
        "max_tgt_length": 512,
