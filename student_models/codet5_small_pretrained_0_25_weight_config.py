...
def codet5_small_pretrained_0_25_weight_config(base_path):
    return {
        # --- Data Args ---
        ...
        "alpha_ce": 0.75,            # Weight for student's own Cross-Entropy loss
        "alpha_distil": 0.25,        # Weight for distillation loss (e.g., KL divergence)
